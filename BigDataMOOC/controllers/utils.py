...
class BaseHandler(ApplicationHandler):
    ...
    def get_all_lessons(self):
        ...
        all_lessons = {}
        for u in all_units:
            all_lessons[u.unit_id] = self.get_course().get_lessons(u.unit_id)
        return all_lessons
...
class HangoutHandler(BaseHandler):
    """Handler for hangout-on-air page."""
    def get(self):
        """Handles GET requests."""
        student = self.personalize_page_and_get_enrolled(
            supports_transient_student=True)
        ...
        self.template_value['navbar'] = {'hangout': True}
        self.render('hangout-on-air.html')
...
class StudentProfileHandler(BaseHandler):
    ...
    def get(self):
        ...
        name = student.name
        age = student.age #Age
        education = student.education   #Education
        profession = student.profession #Profession
        motivation = student.motivation #Motivation
        ...
        self.template_value['student_age'] = age #Age
        self.template_value['student_profession'] = profession #Profession
        self.template_value['student_education'] = education   #Education
        self.template_value['student_motivation'] = motivation #Motivation
